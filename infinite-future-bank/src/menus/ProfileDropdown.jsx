  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-3 w-full text-left group px-3 py-2 rounded-2xl hover:bg-white/40 active:bg-slate-200 transition-colors border border-transparent hover:border-white/60 cursor-pointer focus:outline-none"
      >
      ...
      {isProfileMenuOpen && (
        <>
          ...
          ></div>
          <div className="absolute top-full mt-2 right-0 w-64 bg-white/95 backdrop-blur-2xl border border-white/60 shadow-2xl rounded-3xl p-2 z-50 animate-in fade-in slide-in-from-top-4 origin-top-right">
